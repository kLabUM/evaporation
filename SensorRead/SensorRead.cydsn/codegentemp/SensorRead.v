// ======================================================================
// SensorRead.v generated from TopDesign.cysch
// 05/07/2014 at 18:44
...
module ADC_DelSig_v3_0_0 (
	...
	cy_clock_v1_0
		#(.id("511b7272-6f69-4096-b603-c69de19bcce4/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("511b7272-6f69-4096-b603-c69de19bcce4/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Vaisala_RH_net;
	wire [0:0] tmpFB_0__Vaisala_RH_net;
	wire [0:0] tmpIO_0__Vaisala_RH_net;
	wire [0:0] tmpINTERRUPT_0__Vaisala_RH_net;
	electrical [0:0] tmpSIOVREF__Vaisala_RH_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .width(1))
		Vaisala_RH
		 (.oe(tmpOE__Vaisala_RH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vaisala_RH_net[0:0]}),
		  .analog({Net_218}),
		  .io({tmpIO_0__Vaisala_RH_net[0:0]}),
		  .siovref(tmpSIOVREF__Vaisala_RH_net),
		  .interrupt({tmpINTERRUPT_0__Vaisala_RH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vaisala_RH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Vaisala_Temp_net;
	wire [0:0] tmpFB_0__Vaisala_Temp_net;
	wire [0:0] tmpIO_0__Vaisala_Temp_net;
	wire [0:0] tmpINTERRUPT_0__Vaisala_Temp_net;
	electrical [0:0] tmpSIOVREF__Vaisala_Temp_net;

	cy_psoc3_pins_v1_10
		#(.id("95892a37-6f53-4ff2-86c0-a44cad5a0547"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		Vaisala_Temp
		 (.oe(tmpOE__Vaisala_Temp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vaisala_Temp_net[0:0]}),
		  .analog({Net_219}),
		  .io({tmpIO_0__Vaisala_Temp_net[0:0]}),
		  .siovref(tmpSIOVREF__Vaisala_Temp_net),
		  .interrupt({tmpINTERRUPT_0__Vaisala_Temp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vaisala_Temp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
