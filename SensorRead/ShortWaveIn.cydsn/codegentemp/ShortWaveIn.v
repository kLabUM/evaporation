// ======================================================================
// ShortWaveIn.v generated from TopDesign.cysch
// 05/07/2014 at 18:45
...
module ADC_DelSig_v3_0_0 (
	...
	cy_clock_v1_0
		#(.id("28735b3b-e1f2-487b-ad80-001eae10b693/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("28735b3b-e1f2-487b-ad80-001eae10b693/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1012145748.98785"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
module CharLCD_v1_90_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a5b7057b-66d3-4db6-a0e6-30ea4937f527/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__SW_In_Pos_net;
	wire [0:0] tmpFB_0__SW_In_Pos_net;
	wire [0:0] tmpIO_0__SW_In_Pos_net;
	wire [0:0] tmpINTERRUPT_0__SW_In_Pos_net;
	electrical [0:0] tmpSIOVREF__SW_In_Pos_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .width(1))
		SW_In_Pos
		 (.oe(tmpOE__SW_In_Pos_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW_In_Pos_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__SW_In_Pos_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_In_Pos_net),
		  .interrupt({tmpINTERRUPT_0__SW_In_Pos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_In_Pos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SW_In_Neg_net;
	wire [0:0] tmpFB_0__SW_In_Neg_net;
	wire [0:0] tmpIO_0__SW_In_Neg_net;
	wire [0:0] tmpINTERRUPT_0__SW_In_Neg_net;
	electrical [0:0] tmpSIOVREF__SW_In_Neg_net;

	cy_psoc3_pins_v1_10
		#(.id("b52bcfd0-1d89-41a1-bcee-8784dd37bf92"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		SW_In_Neg
		 (.oe(tmpOE__SW_In_Neg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW_In_Neg_net[0:0]}),
		  .analog({Net_2}),
		  .io({tmpIO_0__SW_In_Neg_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_In_Neg_net),
		  .interrupt({tmpINTERRUPT_0__SW_In_Neg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_In_Neg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
