...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW0, 0x25u);
...
uint8 CYXDATA * const CYCODE AMux_CYAMUXSIDE_A__addrTable[8] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_CYAMUXSIDE_A__maskTable[8] = {
	0x80u, 
	0x20u, 
	0x08u, 
	0x02u, 
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE AMux_CYAMUXSIDE_B__addrTable[16] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_CYAMUXSIDE_B__maskTable[16] = {
	0x40u, 0x00u, 
	0x10u, 0x00u, 
	0x04u, 0x00u, 
	0x01u, 0x00u, 
