// ======================================================================
// Thermocouple.v generated from TopDesign.cysch
// 06/11/2014 at 15:13
...
module CharLCD_v1_90_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e35609a6-08ee-4f6d-853c-caf2987debba/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    defparam AMux_CYAMUXSIDE_A.one_active = 1;
    ...
    defparam AMux_CYAMUXSIDE_B.one_active = 1;
    defparam AMux_CYAMUXSIDE_B.connect_mode = 1;
    
    // -- AMux AMux end --

	wire [0:0] tmpOE__Thermocouple_Pos_net;
	wire [0:0] tmpFB_0__Thermocouple_Pos_net;
	wire [0:0] tmpIO_0__Thermocouple_Pos_net;
	wire [0:0] tmpINTERRUPT_0__Thermocouple_Pos_net;
	electrical [0:0] tmpSIOVREF__Thermocouple_Pos_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .width(1))
		Thermocouple_Pos
		 (.oe(tmpOE__Thermocouple_Pos_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Thermocouple_Pos_net[0:0]}),
		  .analog({Net_110}),
		  .io({tmpIO_0__Thermocouple_Pos_net[0:0]}),
		  .siovref(tmpSIOVREF__Thermocouple_Pos_net),
		  .interrupt({tmpINTERRUPT_0__Thermocouple_Pos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Thermocouple_Pos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Thermocouple_Neg_net;
	wire [0:0] tmpFB_0__Thermocouple_Neg_net;
	wire [0:0] tmpIO_0__Thermocouple_Neg_net;
	wire [0:0] tmpINTERRUPT_0__Thermocouple_Neg_net;
	electrical [0:0] tmpSIOVREF__Thermocouple_Neg_net;

	cy_psoc3_pins_v1_10
		#(.id("f356cf03-ddb6-4e02-b4b1-4498fa69ec0a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		Thermocouple_Neg
		 (.oe(tmpOE__Thermocouple_Neg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Thermocouple_Neg_net[0:0]}),
		  .analog({Net_135}),
		  .io({tmpIO_0__Thermocouple_Neg_net[0:0]}),
		  .siovref(tmpSIOVREF__Thermocouple_Neg_net),
		  .interrupt({tmpINTERRUPT_0__Thermocouple_Neg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Thermocouple_Neg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
