// ======================================================================
// TransmitReadings_freeSoC.v generated from TopDesign.cysch
// 08/15/2014 at 12:18
...
module ADC_DelSig_v3_0_4 (
	...
	cy_clock_v1_0
		#(.id("aba60aaf-093a-44e1-8c56-99ed1b08d29f/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("aba60aaf-093a-44e1-8c56-99ed1b08d29f/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
    ...
    UART_v2_30_1 UART_Wind (
        ...
        .rx_data(Net_23),
        .rx_clk(Net_24));
    defparam UART_Wind.Address1 = 0;
    defparam UART_Wind.Address2 = 0;
    defparam UART_Wind.EnIntRXInterrupt = 0;
    defparam UART_Wind.EnIntTXInterrupt = 0;
    defparam UART_Wind.FlowControl = 0;
    defparam UART_Wind.HalfDuplexEn = 0;
    defparam UART_Wind.HwTXEnSignal = 1;
    defparam UART_Wind.NumDataBits = 8;
    defparam UART_Wind.NumStopBits = 1;
    defparam UART_Wind.ParityType = 0;
    defparam UART_Wind.RXEnable = 1;
    defparam UART_Wind.TXEnable = 1;

	wire [0:0] tmpOE__Wind_Rx_net;
	wire [0:0] tmpIO_0__Wind_Rx_net;
	wire [0:0] tmpINTERRUPT_0__Wind_Rx_net;
	electrical [0:0] tmpSIOVREF__Wind_Rx_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .width(1))
		Wind_Rx
		 (.oe(tmpOE__Wind_Rx_net),
		  .y({1'b0}),
		  .fb({Net_18}),
		  .io({tmpIO_0__Wind_Rx_net[0:0]}),
		  .siovref(tmpSIOVREF__Wind_Rx_net),
		  .interrupt({tmpINTERRUPT_0__Wind_Rx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Wind_Rx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Wind_Tx_net;
	wire [0:0] tmpFB_0__Wind_Tx_net;
	wire [0:0] tmpIO_0__Wind_Tx_net;
	wire [0:0] tmpINTERRUPT_0__Wind_Tx_net;
	electrical [0:0] tmpSIOVREF__Wind_Tx_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .width(1))
		Wind_Tx
		 (.oe(tmpOE__Wind_Tx_net),
		  .y({Net_13}),
		  .fb({tmpFB_0__Wind_Tx_net[0:0]}),
		  .io({tmpIO_0__Wind_Tx_net[0:0]}),
		  .siovref(tmpSIOVREF__Wind_Tx_net),
		  .interrupt({tmpINTERRUPT_0__Wind_Tx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Wind_Tx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("aba4e3db-2c29-427c-8d33-752553706025"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Battery_Ground_net;
	wire [0:0] tmpFB_0__Battery_Ground_net;
	wire [0:0] tmpIO_0__Battery_Ground_net;
	wire [0:0] tmpINTERRUPT_0__Battery_Ground_net;
	electrical [0:0] tmpSIOVREF__Battery_Ground_net;

	cy_psoc3_pins_v1_10
		#(.id("388bea8f-bf97-4db8-9c90-e4b21b86f287"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		Battery_Ground
		 (.oe(tmpOE__Battery_Ground_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Battery_Ground_net[0:0]}),
		  .analog({Net_179}),
		  .io({tmpIO_0__Battery_Ground_net[0:0]}),
		  .siovref(tmpSIOVREF__Battery_Ground_net),
		  .interrupt({tmpINTERRUPT_0__Battery_Ground_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Battery_Ground_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
